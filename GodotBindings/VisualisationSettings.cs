...
public class SoilVisualisationSettings
{
	...
	// MATERIAL SETTINGS
	public StandardMaterial3D SoilCellMaterial = new StandardMaterial3D { AlbedoColor = new(0.5f, 0.5f, 0.5f)/*, ShadingMode = 0, DisableReceiveShadows = true, DisableAmbientLight = true*/ };

	public StandardMaterial3D MarkerMaterial = new StandardMaterial3D { AlbedoColor = new(0f, 0.2f, 0.6f), ShadingMode = 0 };
	...
	public Mesh SoilCellShape = new BoxMesh();// GeoBuilder.UnitCube();
